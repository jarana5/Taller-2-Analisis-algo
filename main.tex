...
El algoritmo implementa la estrategia de dividir y vencer para adivinar un numero en un rango dado. Supongamos que el rango dado es \(1\) a \(n\) y el numero a adivinar es \(x\).
